...
protocol AdBannerVCDelegate: NSObjectProtocol {
...
final class AdBannerViewController: UIViewController {
    ...
    weak var delegate: AdBannerVCDelegate?
...
//        timer = Timer.scheduledTimer(timeInterval: TimeInterval(truncating: scrollingTime), target: self, selector: #selector(self.startAutoScrolling), userInfo: nil, repeats: true)
    ...
    func requestGetBanner(position: InnerBannerPositionType) {
        viewModel.getShopBannerList(by: position.rawValue)
            .asObservable()
...
extension AdBannerViewController: UIScrollViewDelegate {
